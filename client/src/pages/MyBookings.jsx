...
const MyBookings = () => {
    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 my-16 text-sm max-w-7xl'>
                ...
                {bookings.map((booking, index) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
                        ...
                        <div className='md:col-span-1'>
                            ...
                            <p>{booking.car.year} &bull; {booking.car.category} &bull; {booking.car.location}</p>
                        </div>
