...
const CarDetails = () => {
    ...
    const currency = import.meta.env.VITE_CURRENCY || 'रू';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div className='lg:col-span-2'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className="grid lg:grid-cols-2 sm:grid-cols-4 gap-4">
                            {[
                                ...
                                <div key={text} className='flex flex-col items-center bg-light p-4 mb-4 rounded-lg'>
                        ...
                        <div className='mb-8'>
                            ...
                            <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                                {
                                    ["360 Cameras", "Bluetooth", "GPS Navigation", "Heated Seats", "Sunroof", "Apple CarPlay"].map((item) => (
